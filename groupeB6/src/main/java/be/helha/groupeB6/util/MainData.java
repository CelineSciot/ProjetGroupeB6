...
public class MainData {
	...
	public static void main(String[] args) {
		...
		Evenement evt1 = new Evenement(null, "Marche nocturne", evtD1, "individuel", 1700,true, images);
		
		String evtD2 ="Un marché aux jouets sera organisé où les bénéfices seront reversés à médecin sans frontières.";
		Evenement evt2 = new Evenement(null, "Marché aux jouets", evtD2, "collectif", 500,false, images);
		
		String evtD3 ="Marathon de Durbuy dans une ambiance assurée. Participation: 5€ /couple";
		Evenement evt3 = new Evenement(null, "Marathon de Durbuy", evtD3, "collectif", 15220,false, images);
